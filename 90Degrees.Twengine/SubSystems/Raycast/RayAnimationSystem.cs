...
{
    public class RayAnimationSystem : EntityProcessingSystem
    {
        private ComponentMapper<RaycastSprite> mSpriteMapper;
        ...
        public RayAnimationSystem(Raycaster raycaster)
            : base(typeof(RaycastSprite), typeof(SpriteAnimator), typeof(Transform))
        {
        ...
        {
            mSpriteMapper = new ComponentMapper<RaycastSprite>(world);
        ...
        {
            RaycastSprite sprite = mSpriteMapper.Get(e);
        ...
        private int GetNextFrameIndex(Transform transform, SpriteAnimator animator, RaycastSprite sprite)
        {
