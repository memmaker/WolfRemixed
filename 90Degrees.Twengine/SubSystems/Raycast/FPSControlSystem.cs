...
namespace Twengine.SubSystems.Raycast
{
    ...
    public class FPSControlSystem : EntityProcessingSystem
    {
        ...
        protected ComponentMapper<FPSControl> mMovementControlMapper;
        ...
        public FPSControlSystem(Raycaster raycaster, int screenWidth, int screenHeight, float mouseSensitivity)
            : base(typeof(FPSControl), typeof(Transform))
        {
        ...
        {
            mMovementControlMapper = new ComponentMapper<FPSControl>(world);
        ...
        public override void Process(Entity e)
        {
            ...
            FPSControl movementControl = mMovementControlMapper.Get(e);
            
            Rotate(transform, world.Delta);
            Move(movementControl, transform, world.Delta);
        ...
        private void Rotate(Transform transform, float worldDelta)
        {
