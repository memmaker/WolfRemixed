...
{
    public class TiledHitnumberRenderSystem : EntityComponentProcessingSystem<Message, Transform>
    {
        ...
        public override void Process(Entity e, Message message, Transform transform)
        {
            DeferredDrawString(transform, message);
        }
